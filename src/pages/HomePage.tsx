    ...
    <main className="bg-background">
      ...
      <section className="py-10 md:py-48 px-4 border-b border-border/30">
        <div className="container mx-auto max-w-5xl text-center">
          <h2 className="font-magazine italic text-3xl md:text-6xl lg:text-7xl leading-tight md:leading-tight lg:leading-tight font-light text-foreground mb-6 md:mb-12">
            {isWomen
      ...
      {/* Editorial Break */}
      <section className="py-10 md:py-40 bg-[#0a0a0a] text-white text-center px-4">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-magazine italic text-4xl md:text-7xl lg:text-8xl mb-4 md:mb-8 font-light text-white/90">
      ...
      <section className="py-10 md:py-32 px-4 border-t border-border/30">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            <div>
              <h2 className="font-magazine italic text-3xl md:text-5xl mb-4 md:mb-8 font-light">
            ...
            <div>
              <h2 className="font-magazine italic text-3xl md:text-5xl mb-4 md:mb-8 font-light">Why Choose VPPA?</h2>
      ...
      {/* Newsletter */}
      <section className="py-10 md:py-40 bg-accent/5 border-t border-border/30">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <span className="text-xs tracking-[0.4em] uppercase text-primary mb-3 md:mb-6 block">
            The Inner Circle
          </span>
          <h2 className="font-magazine italic text-4xl md:text-6xl mb-4 md:mb-8 font-light">
            Stay in the Know
          </h2>
          <p className="text-muted-foreground mb-6 md:mb-12 font-light leading-relaxed">
